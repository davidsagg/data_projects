...
import { Users, FolderKanban, MapPin, BellRing } from 'lucide-react'
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-8">
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <StatTile label="Lembretes pendentes" value={stats.upcoming_reminders.length} icon={<BellRing size={20} />} />
      </div>

      <div className="grid grid-cols-2 gap-6">
        <Card>
          <h2 className="mb-4 text-sm font-semibold text-text">Top empresas</h2>
          <HorizontalBarChart data={stats.top_companies.map((c) => ({ label: c.value, value: c.count }))} />
        </Card>
        <Card>
